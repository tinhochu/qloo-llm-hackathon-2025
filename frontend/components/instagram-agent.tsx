...
function InstagramAgentSkeleton() {
  return (
...
function InstagramAgent({ item, preFetchedData }: any) {
  // Use pre-fetched data if available, otherwise return skeleton
  if (!preFetchedData) {
    return <InstagramAgentSkeleton />
  }
  ...
  return (
    <Popover>
      <PopoverTrigger>
        <Badge className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-3 py-1 text-xs font-bold uppercase tracking-wide rounded-xl overflow-hidden border-none hover:cursor-pointer hover:scale-95 transition-all duration-300">
...
export { InstagramAgent, InstagramAgentSkeleton }
